...
return [
    ...
    'addSomeVideosToGetStarted' => 'Añadir algunos vídeos para empezar',
    ...
    'aspectRatiosMessage' => 'Recomendación: 16:9 para horizontal, 9:16 para vertical.',
    'backToPlaylists' => 'Volver a listas de reproducción',
    'caption' => 'Título',
    'changeThumbnail' => 'Cambiar la imagen en miniatura',
    'clearPlaylistSearch' => 'Borrar búsqueda',
    ...
    'download' => 'Descargar',
    'downloadMessage' => 'Permitir que otros descarguen este vídeo',
    'dragAndDropVideosToReorder' => 'Arrastra y suelta los vídeos para cambiarlos de orden en la lista de reproducción',
    'duet' => 'Dúo',
    'duetMessage' => 'Permitir que otros hagan un dúo con este vídeo utilizando el suyo propio',
    ...
    'orDragAndDropItHere' => 'O arrastra y suéltalos aquí',
    ...
    'playlistsDisabledByAdmin' => 'Las listas de reproducción han sido desactivadas por un administrador. Si crees que se trata de un error, ponte en contacto con el servicio de soporte técnico.',
    'playlistsUnavailable' => 'Listas de reproducción no disponibles',
    'posts' => 'Publicaciones',
    ...
    'selectVideoToUpload' => 'Selecciona el vídeo que deseas cargar',
    'settings' => 'Ajustes',
    ...
    'tip' => 'Consejo',
    'tryDifferentPlaylistSearch' => 'Prueba con otro término de búsqueda o borra la búsqueda para ver todas las listas de reproducción',
    'unsavedWarning' => 'El vídeo que estabas editando no se ha guardado. ¿Quieres continuar con la edición?',
    'uploadFirstVideo' => 'Cargar el primer vídeo',
    'uploadThumbnail' => 'Cargar imagen en miniatura',
    'users' => 'usuarios',
