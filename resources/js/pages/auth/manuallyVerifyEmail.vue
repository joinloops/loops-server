    ...
    <FullLayout>
        ...
        >
            <div class="w-full max-w-md">
                ...
                >
                    <i
                        class="bx bx-loader-alt animate-spin text-4xl text-blue-600 dark:text-blue-400 mb-4"
                    ></i>
                ...
                <template v-else>
                    <div class="text-center mb-8">
                        ...
                        >
                            <i
                                class="bx bx-envelope text-blue-600 dark:text-blue-400 text-[24px]"
                            ></i>
                        </div>
                    ...
                    >
                        ...
                        >
                            <i
                                class="bx bx-check text-green-600 dark:text-green-400 text-[32px]"
                            ></i>
                        </div>
