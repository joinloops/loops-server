    ...
    <MainLayout>
        ...
        >
            ...
            <ProfileTabBar
                :show-private-tabs="
                    ...
                    profileStore.id === authStore.getUser?.id
                "
            ...
            <div
                v-if="profileStore.isLoadingMorePosts"
            ...
            <div
                v-else-if="profileStore.relationship.blocking"
                class="flex justify-center py-8"
            >
            ...
            <div
                v-else-if="
                    posts && posts.length > 0 && !profileStore.hasMorePosts
                "
                class="flex justify-center py-8"
            >
                <p class="text-gray-500 dark:text-gray-400 text-sm">
        ...
        <div v-else-if="error" class="pt-[90px] px-5 overflow-hidden">
            ...
            >
                ...
                <h2
                    class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-3"
                >
                    {{
