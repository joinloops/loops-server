                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <button
                                    ...
                                    @click="
                                        requestSelectiveExport(exportType.id)
                                    "
                                >
                            ...
                            >
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        >
                                            <i
                                                class="bx bx-download text-gray-600 text-[20px]"
                                            ></i>
                                        </div>
                                        <div>
                                            <h4
                ...
                >
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div
                                class="text-center p-3 bg-gray-50 dark:bg-gray-900 rounded-lg"
                            >
                                <div
                                    class="text-2xl font-bold text-blue-600 dark:text-white mb-1"
                                >
                                    {{ dataStats.videos }}
                                </div>
                                <div
                            ...
                            >
                                <div
                                    class="text-2xl font-bold text-green-600 dark:text-white mb-1"
                                >
                                    {{ dataStats.comments }}
                                </div>
                                <div
