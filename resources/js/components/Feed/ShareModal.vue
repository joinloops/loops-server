                            ...
                            <template v-else>
                                <div>
                                    <div class="-mx-1 flex gap-1.5 overflow-x-auto px-1 py-1">
                                        ...
                                        >
                                            <div
                                                class="flex h-10 w-10 items-center justify-center rounded-full text-white transition hover:opacity-90"
...
const fediversePlatforms = [
    {
        ...
        buildUrl: (server, url, text) => `https://${server}/search?q=${encodeURIComponent(url)}`
    },
    {
        id: 'mastodon',
        name: 'Mastodon',
...
const externalPlatforms = [
    {
        ...
        url: (url, text) => `https://bsky.app/intent/compose?text=${encodeURIComponent(`${url}`)}`
    },
    {
        id: 'facebook',
        name: 'Facebook',
    ...
    },
    {
        ...
        url: (url, text) =>
            `https://www.threads.com/intent/post?text=${encodeURIComponent(`${url}`)}`
    },
    {
        id: 'twitter',
        name: 'X',
        ...
        url: (url, text) => `https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}`
    },
    {
        id: 'whatsapp',
        name: 'WhatsApp',
        ...
        url: (url, text) => `https://wa.me/?text=${encodeURIComponent(`${url}`)}`
    }
]
