...
class DeliverCreateCommentActivity implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        return "deliver-comment-create-{$this->comment->id}-{$this->inboxUrl}";
    }
     ...
     */
    public function __construct(Comment $comment, string $inboxUrl, array $recipientProfileIds = [])
    {
    ...
    public function handle(): void
    {
        ...
        $activity = CreateActivityBuilder::buildForComment($actor, $comment);
