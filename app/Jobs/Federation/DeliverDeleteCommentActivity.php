...
class DeliverDeleteCommentActivity implements ShouldBeUnique, ShouldQueue
{
    use Batchable, Queueable;

    public $profile;

    public $commentObjectUrl;
    ...
    {
        return "deliver-comment-delete-{$this->commentObjectUrl}-{$this->inboxUrl}";
    }
    ...
    public function handle(): void
    {
        ...
        $activity = DeleteActivityBuilder::buildForComment($actor, $this->commentObjectUrl);
